...
const content: VsContent = {
  ...
  whenUsBetter: [
    'You want your free event to be uncapped. SnapWorxx’s free event takes unlimited uploads; GuestPix’s free plan stops at around 50 photos.',
  ...
  rows: [
    ...
    { label: 'Free option', us: 'One full free event per email, unlimited uploads, 30-day gallery', them: 'Free plan, around 50 photos / 30 days' },
  ...
  faqs: [
    ...
    },
    {
      ...
      a: 'GuestPix caps its free plan at roughly 50 photos over 30 days, and you can keep using it. SnapWorxx gives one free event per email with unlimited uploads and a 30-day gallery. If you want to run one real event free, ours goes further; if you want a permanently free low-volume option, theirs does.',
    },
    {
