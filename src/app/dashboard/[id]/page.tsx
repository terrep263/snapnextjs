              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      ...
                      View, hide, or delete them in the photo manager.
                    </p>
                  </div>
                </div>
                <div className="flex flex-shrink-0 gap-3">
                  <Link
                    href={`/e/${eventData?.slug}`}
                    target="_blank"
                    className="inline-flex items-center justify-center gap-2 rounded-lg border border-purple-600 px-4 py-2 text-sm font-medium text-purple-600 transition-colors hover:bg-purple-50"
                  >
                    View Gallery
                  </Link>
                  <Link
                    href={`/dashboard/${eventId}/photos`}
                    className="inline-flex items-center justify-center gap-2 rounded-lg bg-purple-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-purple-700"
                  >
                    Manage Photos
