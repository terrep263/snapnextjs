          ...
          >
            ...
            <motion.div className="absolute left-0 top-0 bottom-0 w-72 bg-gray-900 shadow-xl flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-4">
                {/* Quick Actions (Owner/Guest) */}
                {eventId && eventSlug && (
                  <div className="space-y-2 pb-4 border-b border-gray-800">
                    <a
                      href={`/dashboard/${eventId}`}
                      className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-bold py-3 px-4 rounded-lg transition-all shadow-lg"
                    >
                    ...
                    <a
                      href={`/e/${eventSlug}/upload`}
                      className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-bold py-3 px-4 rounded-lg transition-all shadow-lg"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
