...
export interface GalleryControlsProps {
  ...
  sticky?: boolean;
  /** When true, shows a "Download all" button wired to onBulkDownload. */
    ...
    >
      <div className="container mx-auto px-4 sm:px-5 lg:px-6">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-4 py-4">
          {/* Left Side: Upload + optional Download All */}
          <div className="flex-shrink-0 flex flex-col sm:flex-row gap-2 sm:gap-3">
            ...
            {canBulkDownload && onBulkDownload && (
              <button
                onClick={onBulkDownload}
                className="w-full sm:w-auto px-5 py-3 bg-white border border-purple-600 text-purple-600 hover:bg-purple-50 font-semibold rounded-lg transition-colors duration-200 flex items-center justify-center gap-2 shadow-sm"
                title="Download all photos and videos as a ZIP"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
